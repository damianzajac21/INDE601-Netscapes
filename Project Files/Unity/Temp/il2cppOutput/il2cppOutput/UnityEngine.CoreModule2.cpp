...
IL_0064:
	{
		...
		double L_19 = sqrt((((double)((double)(double)L_18))));
		V_5 = (((float)((float)(float)L_19)));
		float L_20 = (&___current0)->get_x_2();
		float L_21 = V_0;
		float L_22 = V_5;
		float L_23 = ___maxDistanceDelta2;
		float L_24 = (&___current0)->get_y_3();
		float L_25 = V_1;
		float L_26 = V_5;
		float L_27 = ___maxDistanceDelta2;
		float L_28 = (&___current0)->get_z_4();
		float L_29 = V_2;
		float L_30 = V_5;
		float L_31 = ___maxDistanceDelta2;
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_32;
		memset((&L_32), 0, sizeof(L_32));
		Vector3__ctor_m08F61F548AA5836D8789843ACB4A81E4963D2EE1((&L_32), ((float)il2cpp_codegen_add((float)L_20, (float)((float)il2cpp_codegen_multiply((float)((float)((float)L_21/(float)L_22)), (float)L_23)))), ((float)il2cpp_codegen_add((float)L_24, (float)((float)il2cpp_codegen_multiply((float)((float)((float)L_25/(float)L_26)), (float)L_27)))), ((float)il2cpp_codegen_add((float)L_28, (float)((float)il2cpp_codegen_multiply((float)((float)((float)L_29/(float)L_30)), (float)L_31)))), /*hidden argument*/NULL);
		V_4 = L_32;
		goto IL_00a4;
	}
